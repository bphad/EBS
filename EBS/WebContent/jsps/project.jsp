				...
				<div class="row">
					<div class="col-lg-12 ">
						...
						<ul class="nav nav-tabs">
							<li class="active"><a href="#add" data-toggle="tab">Add Project</a></li>
							<li class=""><a href="#status1" data-toggle="tab">Project Status</a></li>
							<li class=""><a href="#broadcast" data-toggle="tab">Broadcast</a></li>
							<li class=""><a href="#closure" data-toggle="tab">Project Closure</a></li>
							<li class=""><a href="#change" data-toggle="tab">Change Manager</a></li>
						</ul>
						<div class="tab-content">
									...
									<sv:form method="post" action="${pageContext.request.contextPath }/AddProject" modelAttribute="proj">
                              			...
                              			<sv:select path="manager_id" class="form-control">
											<c:forEach var="e" items="${emp_list }">
												<option value='<c:out value="${e.getId() }"/>'>
							...
							<div class="tab-pane fade" id="status1"><br>
								<div align="left">
									<font size="4" color="blue">All Active Projects</font>&nbsp;&nbsp;|&nbsp;&nbsp; 
									<font size="4" color="blue"><a href="#" >All Past/Completed Projects</a></font>
								</div>
									...
									<c:if test='${p.getStatus() == "open" }'>
										<h3><c:out value="${p.getName()}"/></h3>
                              				Start Date: <c:out value="${p.getStart_date() }" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||
                               				...
                               				Client Name: <c:out value="${p.getClient_name() }"/><BR>
								...
								<p>
									<select name="project" class="form-control">
										<c:forEach var="p" items="${proj_list}">
											<option <c:out value="${p.getId()}"/>><c:out value="${p.getName()}"/>------<c:out value="${p.getClient_name()}"/></option>
										</c:forEach>	
									</select><BR> 
							...
							<div class="tab-pane fade" id="closure">
								...
								<p>
									...
									Comments:<textarea name="comments" class="form-control"> </textarea><BR>
									<input type="submit" value="Add Project to Archives" class="btn btn-primary">
								</p>
							</div>
							<div class="tab-pane fade" id="change">
								...
								<form method="post" action="${pageContext.request.contextPath }/ChangeManager">
									<p>
										Select Project: <select name="pid" class="form-control">
											<c:forEach var="p" items="${proj_list }">
										...
										Select Manager: <select name="eid" class="form-control">
											<c:forEach var="e" items="${emp_list }">
												<option value='<c:out value="${e.getId() }"/>'>
													<c:out value="${e.getName() }" /> --
													<c:out value="${e.getJob_title() }" />
										...
										<input type="submit" value="Change Manager" class="btn btn-primary">
									</p>
								</form>
							</div>
						</div>
