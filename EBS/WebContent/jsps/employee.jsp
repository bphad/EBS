					...
					<div class="col-lg-12 ">
						<h5>Employee Management</h5>
							<ul class="nav nav-tabs">
								<li class="active"><a href="#add" data-toggle="tab">Add Employee</a></li>
								<li class=""><a href="#record" data-toggle="tab">Employee Record</a></li>
								<li class=""><a href="#assign" data-toggle="tab">Assign to Project</a></li>
								<li class=""><a href="#unassign" data-toggle="tab">Un-Assign from Project</a></li>
								<li class=""><a href="#message" data-toggle="tab">Send Message</a></li>
							</ul>
							...
							<div class="tab-pane fade active in" id="add">
								...
								<p>
									<sv:form method="post" action="${pageContext.request.contextPath }/AddEmployee" commandName="emp">
                                		...
                                		Username:<sv:input type="text" path="username" class="form-control" placeholder="employee email will be the username" disabled="true" /><BR>
										...
										<p>
											...
											<select name="pid" class="form-control">
												<c:forEach var="p" items="${proj_list }">
													<option value='<c:out value="${p.getId() }"/>'><c:out value="${p.getName() }" /> --
								...
								<h4>Un-Assign Employee from Project</h4>
									<form method="post" action="${pageContext.request.contextPath }/UnAssignEmployeeToProject">
										<p>
											...
											<input type="submit" value="Un Assign from project" class="btn btn-primary">
										</p>
									</form>
								</div>
								...
								<h4>Send Message to Employee</h4>
									<form method="post" action="${pageContext.request.contextPath }/SendEmployeeMessage">
										<p>
											...
											Message: <textarea name="msg" class="form-control"></textarea><BR>
